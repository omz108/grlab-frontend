export function RudrakshaReportCard({ report }: { report: any }) {
    const fields = [
      ...
      { label: "Mounted", value: report.mounted },
      { label: "Shape", value: report.shape },
      { label: "Dimension", value: report.dimension },
      { label: "Natural Faces", value: report.naturalFaces },
      { label: "Artificial Faces", value: report.artificialFaces },
      { label: "Test Came Out", value: report.testCameOut },
      { label: "X-Ray Result", value: report.xRayResult },
      { label: "Origin", value: report.origin},
      { label: "Comment", value: report.comment}
    ];
